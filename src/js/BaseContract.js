    ...
    deployContract(contractOwner, overrideSendOptions, ...contractConstructorParams) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                const wallet = new ethers_1.Wallet(privateKey, this.transactionsProvider);
                ...
                this.contract = new ethers_1.Contract(transactionReceipt.contractAddress, this.jsonInterface, wallet);
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                if (txSignerAddress) {
                    ...
                    const wallet = new ethers_1.Wallet(privateKey, this.transactionsProvider);
                    contract = new ethers_1.Contract(this.contract.address, this.jsonInterface, wallet);
                }
                // send the transaction
